...
**Purpose:** Controls for `patch_vuln` aligned to **Ubuntu 24.04 LTS DISA‑STIG**.
...
- Templates for this category live under `roles/baseline/patch_vuln/templates/` and are referenced with `src: "{ '{' } role_path { '}' }/patch_vuln/templates/<file>.j2"`.
