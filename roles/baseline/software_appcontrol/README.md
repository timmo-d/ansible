...
**Purpose:** Controls for `software_appcontrol` aligned to **Ubuntu 24.04 LTS DISA‑STIG**.
...
- Templates for this category live under `roles/baseline/software_appcontrol/templates/` and are referenced with `src: "{ '{' } role_path { '}' }/software_appcontrol/templates/<file>.j2"`.
