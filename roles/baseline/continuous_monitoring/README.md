...
- Templates for this category live under `roles/baseline/continuous_monitoring/templates/` and are referenced with `src: "{ '{' } role_path { '}' }/continuous_monitoring/templates/<file>.j2"`.
